...
*Tdd-project* is a project where we have implemented a class with some methods, using test-driven development (TDD).The main purpose is to write tests first and then the code. 
<br/>
...
```sh
  cd my-folder
  git clone git@github.com/IvonneBenitesRodriguez/tdd-project.git
```
